...
public class SubjectFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        refreshFragment();
        Button button = (Button) view.findViewById(R.id.fs_insertSubject);
       button.setOnClickListener(new View.OnClickListener() {
           @Override
            public void onClick(View view) {
              ...
              is_insertOrUpdate.setText("Them mon hoc");
               is_insertOrUpdate.setOnClickListener(new View.OnClickListener() {
                  @Override
                  public void onClick(View view) {
                      int i = new DAO(getActivity()).insertSubject(is_subjectName.getText().toString());
                      if (i == 1) {
    ...
    public void refreshFragment(){
        ...
        final ListView lv = (ListView) getActivity().findViewById(R.id.fs_listView);
        lv.setAdapter(new CustomListSubjectAdapter(getActivity(), arrayList));
    }
}